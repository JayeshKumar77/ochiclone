...
function LandingPage() {
  return (
    <div data-scroll data-scroll-speed="-.3"  className=" h-[550px]  w-full">
      <div className="textstructure max-md:pl-[4vw] pl-8 mt-[12vw] max-md:mt-28 max-md:mb-40 relative">
        
      <svg className="max-md:scale-50 absolute right-0 max-md:origin-right" width="53.08" height="171.358">
              ...
              <div className="w-fit flex">
                {index === 1 && (
                  <motion.div
                    ...
                    className="max-md:w-13 max-md:h-13 mr-[1vw] w-[9vw] top-[1.2vw] rounded-md h-[5.4vw] relative bg-zinc-500 overflow-hidden">
                    <img className=" bg-cover w-full h-full" src="https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg" alt="" />
                  </motion.div>
                )}
                <h1 className=' uppercase leading-none max-[410px]:text-2xl max-md:text-5xl text-[7vw] tracking-tighter font-["FoundersG rotesk"] font-bold'>
                  {item}
                </h1>
              </div>
            </div>
      ...
      <div className="border-t-[2px] border-zinc-300 mt-[6vw] flex justify-between max-md:flex-col max-md:gap-8 md:items-center py-[5vw] px-[4vw]">
        {[
          "For public and private companies",
          "From the first pitch to IPO",
        ].map((item, index) => {
          return (
            <p className="text-md tracking-tight leading-none ">
              {item}
            </p>
          );
        })}
        <div className="start flex items-center gap-5">
          <div className="hover:bg-[#212121] hover:text-white transition ease-linear duration-200 uppercase px-3 py-1 border-2 border-zinc-700 rounded-full ">
            Start the project
          </div>
          <div className="hover:bg-[#212121] hover:text-white transition ease-linear duration-200 w-9 h-9 flex items-center justify-center border-2 border-zinc-500 rounded-full max-md:hidden">
